...
## Instruction Files
```text
instructions/add-json-loader-unit-tests.agent.md
instructions/add-pdf-tests.agent.md
instructions/add-unit-tests-with-aggregation.agent.md
...
## Sample Instruction
- File: add-json-loader-unit-tests.agent.md
- Contents:
```text
